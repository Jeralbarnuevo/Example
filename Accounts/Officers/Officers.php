            ...
            <div class="register">
                ...
                <form action="" class="mt-3">
                    <div class="col-md-12 mb-2 box1">
                        ...
                        <input type="email" class="form-control" autocomplete="0" placeholder="Enter Your Email" required>
                      </div>
                      <div class="col-md-12 mb-2 box1">
                        ...
                        <input type="password" class="form-control" autocomplete="0" placeholder="Enter Your Password" required>
                      </div>
                      ...
                      <div class="col-lg-12 mt-2 forgot">
                        <p>Don't have an account? <a href="/PRACTICE/Register/Register.html">Sign up</a></p>
